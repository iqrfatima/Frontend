...
export function Navbar() {
  return (
    <header className="flex h-20 w-full shrink-0 items-center px-4 md:px-6 bg-green-500 shadow-2xl">
      <div className="mr-auto text-white text-3xl font-bold pl-6 ">
        AgriCycle
      </div>
      <Sheet>
      ...
      <nav className="ml-auto hidden lg:flex gap-6 shadow-2xl">
